    ...
    <div>
      ...
      <div className="row">
        <div className="col-xl-3 col-md-6 mb-4">
          <CardCount
            title="Citas totales"
            number={GananciaAnuales.citas.toString() || "0"}
            icon="calendar"
          />
        </div>
        <div className="col-xl-3 col-md-6 mb-4">
          <CardCount
            ...
            number={`$${GananciaAnuales.total.toString() || "0"}`}
            color="success"
            icon="dollar-sign"
          />
        </div>
        <div className="col-xl-3 col-md-6 mb-4">
          <CardCount
            ...
            number={GananciaMensuales.citas.toString() || "0"}
            icon="calendar"
          />
        </div>
        <div className="col-xl-3 col-md-6 mb-4">
          <CardCount
            ...
            number={`$${GananciaMensuales.total.toString() || "0"}`}
            color="success"
            icon="dollar-sign"
          />
        </div>
      ...
      <hr />
      <h2 className="h5 mb-0 text-gray-900">Top Veterinarios</h2>
      <hr />
      <TablaTop veterinarios={topTen} />
      <hr />
